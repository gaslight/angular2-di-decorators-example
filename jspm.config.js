...
SystemJS.config({
  ...
  map: {
    ...
    "angular2-data": "local:angular2-data@0.0.4",
    "angular2-di-decorators": "npm:angular2-di-decorators@0.0.1",
  ...
  packages: {
    ...
    "npm:angular2-di-decorators@0.0.1": {
      "map": {
        "angular2": "npm:angular2@2.0.0-beta.9"
      }
    },
    ...
    "npm:babel-template@6.7.0": {
      "map": {
        "babel-runtime": "npm:babel-runtime@5.8.35",
        "babel-traverse": "npm:babel-traverse@6.7.2",
